...
\end{center}
dass das Hauptschiff von Seitenschiffen flankiert ist. Und genau das ist es, was sich in gotischen Kathedralen tatsächlich wiederholt. Konkrete Hauptschiffe und konkrete Seitenschiffe sind selbstverständlich in verschiedenen Kathedralen verschieden, nicht aber die Art und Weise, wie sie zusammenspielen. Denn genau diese Art des Zusammenspiels, macht eine gotische Kathedrale zu einer gotischen Kathedrale. Natürlich Teilen sich alle gotischen Kathedralen neben den Zusammenspiel ihrer Teile auch einen gewissen Stil, der wiederum durch Pattern beschrieben werden kann. 


\subsection{Die Mustersprache nach Alexander}
Die gesamte Buchtrilogie von Alexander begründet sich auf seine Idee einer universellen Mustersprache. \cite[S. 177 - ???]{Alexander1975}

\subsection{Beispiel: Muster in der Gebäude- und Stadtarchitektur}
A Pattern Language Einleitung \cite[S. IX - XLIV]{Alexander1977}
